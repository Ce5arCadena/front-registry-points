    ...
    <div className="border border-gray-700 text-white rounded-lg w-full h-full relative">
      ...
      <div className="rounded-lg shadow p-6 h-full flex flex-col gap-4">
        ...
        <div className="flex gap-4 w-full items-center justify-center">
          <div className="rounded-md min-w-44 min-h-28 bg-dark-bg-elevated shadow-2xs p-2 transition-all ease-in duration-200 hover:shadow-lg hover:shadow-secondary/80 hover:-translate-y-1 shadow-primary flex flex-col gap-2">
